                    ...
                    {articles.map((post) => {
                        return (
                            <div className='cardSmall' key={post.id}>
                                <div className='left'> <img src={parseImg(post.content)} alt='image' /><br /> </div>
                                <div className='right'>
                                    <h1>{post.title}</h1>

                                    <p> {parsePreview(post.content)} </p>

                                    <div className='sec'><Link href='/article/[id]' as={'/article/' + articles.indexOf(post)}><button>Read More</button></Link></div>
                                </div>
