    ...
    <div>
      ...
      <main>
        <section class="flex landing">
          ...
          <div class="right1">
            <img src='./images/testart.png' class="sectionimage" />
          </div>
        </section>
        <section class="about">
          <h1 className='h1Big'> What Do We Do? </h1>
          <img src='./images/team.png' class="medimg" />
        ...
        <section class="flex list">
          <div class="left1">
            <h2> Math Tutoring </h2>
            <img src='./images/meeting.png' class="smallimg" />
          ...
          <div class="right1">
            ...
            <img src='./images/meeting1.png' class="smallimg" />
          ...
          <div class="right1">
            ...
            <img src='./images/meeting2.png' class="smallimg" />
